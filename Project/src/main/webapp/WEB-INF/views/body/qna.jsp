...
<div class="qna container" style="margin-top:20px;margin-bottom:20px; padding:20px;">
	<div class="header">
	  		<div class="main_text center-align" style="margin-left:auto; margin-right: auto;">
				<img src="resources/img/main.png" class="qnaimg" style="width:50%;">
			</div>
	</div>
	<div class="row">
